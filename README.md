...
Lightweight chrome extension that lets us access `.sol` domains in the browser! Works by redirecting requests for sol domains to the ip address or ipfs hash (TODO) stored in the "content" field on Solana's SPL Name Service.
